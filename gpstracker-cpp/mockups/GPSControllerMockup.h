...
private:
    ...
    {
        this->sentencias.push("$GPRMC,054457,A,3654.928,N,07302.500,W,41.7,2.65,160519,,E*47");             //valido

        this->sentencias.push("$GPRMC,054509,A,3654.923,N,07302.506,W,51.1,2.54,160519,,E*45");             //valido
        ...
        this->sentencias.push("$GPRMC,054500,A,3654.907,N,07302.482,W,75.7,2.56,160519,,E*4E");             //valido
        ...
        this->sentencias.push("$GPRMC,054503,A,3654.925,N,07302.503,W,82.8,2.57,160519,,E*48");             //valido
